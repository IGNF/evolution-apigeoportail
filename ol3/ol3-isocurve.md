...
isocurveOptions     | Object  | Optionnel | Options du service de calcul d'isochrones, tel que paramétrable via la bibliothèque d'accès (Gp.Services.isoCurve). Voir la [documentation technique des paramètres du service](http://ignf.github.io/geoportal-access-lib/v1.0.0-beta.1/jsdoc/module-Services.html#~isoCurve) pour connaître l'ensemble des options.
